...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<script type="text/javascript" charset="UTF-8" src="/eter/runtime/_systemjs/editor/kindeditor-min.js"></script><script type="text/javascript" charset="UTF-8" src="/eter/runtime/_systemjs/editor/lang/zh_CN.js"></script><script type="text/javascript">window.KindEditor.options.uploadJson = "/eter/index.php?controller=pic&action=upload_json";window.KindEditor.options.fileManagerJson = "/eter/index.php?controller=pic&action=file_manager_json";</script>
