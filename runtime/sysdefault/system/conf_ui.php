...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<?php $themeType = IReq::get('type') ? IReq::get('type') : 'site'?>
<?php $themeList = themeroute::themeTypeList($themeType)?>
<?php if(!$themeList){?><?php IError::show(403,'主题信息不存在')?><?php }?>
<?php $themeTypeName = themeroute::themeTypeTxt($themeType)?>
