...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<script type="text/javascript" charset="UTF-8" src="/eter/runtime/_systemjs/my97date/wdatepicker.js"></script>
<div class="headbar">
		...
		<table class="list_table">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="<?php echo IUrl::creatUrl("/comment/refer_edit/id/".$item['id']."");?>"><img class="operator" src="<?php echo $this->getWebSkinPath()."images/admin/icon_edit.gif";?>" alt="修改" /></a>
						<a href="javascript:void(0)" onclick="delModel({link:'<?php echo IUrl::creatUrl("/comment/refer_del/check/".$item['id']."");?>'})"><img class="operator" src="<?php echo $this->getWebSkinPath()."images/admin/icon_del.gif";?>" alt="删除" /></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
